...
function changeRole(array, newRole) {
  ...
  //   array[idx]["role"] = newRole;
  //   console.log(array[idx]);

  //   for (let x in array[idx]) {
  //     console.log(x, array[idx][x]);
  //   }
  // }
}
...
Array.prototype.customProperty = "initial value";
// Створюємо функцію, яка буде додавати нову властивість до масиву

function addProperty(array, val) {
  array.customProperty = val; // "myProperty";
}
...
addProperty(newArr, "myProperty");

const newArr2 = [];
addProperty(newArr2, "myPropertyN");
// Розкоментуйте рядок нижче після виконня завдання для перевірки
console.log(newArr.customProperty); // Виведе myProperty

console.log(newArr2.customProperty); // Виведе myPropertyN
